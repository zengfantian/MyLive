...
public class FormValidationActivity extends FragmentActivity implements DatePickerDialog.OnDateSetListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.demo_form_validation);
...
//		}
	...
	private void validate() {
		...
		if (isValid) {
			ToolAlert.showShort(getResources().getString(R.string.validation_success));
		}
	}
